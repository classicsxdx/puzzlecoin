...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "puzzlecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ec21", "54.186.143.204"}, //1 Seed Node
    {"ec22", "54.186.15.171"}, //1 Seed Node
    {"ec23", "54.186.72.1"}, //1 Seed Node
    {"ec24", "54.187.27.203"}, //1 Seed Node
    {"ec25", "54.187.46.187"}, //1 Seed Node
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. puzzlecoin is probably already running."), addrBind.ToString().c_str());
        else
